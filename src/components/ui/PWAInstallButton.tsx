  ...
  return (
    <>
      ...
      {showAndroidButton && !isIOS && (
        <div className="flex bg-gradient-to-r from-[#A6D49F] to-[#7BB97A] border border-[#4e9643] top-5 left-[10%] fixed text-white p-3 rounded-lg text-[14px] z-50" style={{width: "70%"}}>
          <button
